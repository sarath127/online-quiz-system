...
class Cl_User
{
	...
	public function registration( array $data )
	{
		if( !empty( $data ) ){
			...
			$pno = mysqli_real_escape_string( $this->_con, $trimmed_data['pno'] );
			$dept = mysqli_real_escape_string( $this->_con, $trimmed_data['dept'] );
			
			$college = mysqli_real_escape_string( $this->_con, $trimmed_data['college'] );
			...
			$query = "INSERT INTO users (id, name, email, created,pno,dept,college) VALUES (NULL, '$name', '$email', CURRENT_TIMESTAMP,'$pno','$dept','$college')";
